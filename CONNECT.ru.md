...
## Важно: пароль для входа
Пароль (токен) задаётся через веб-панель: Настройки → Доступ → Создать токен.
При первом входе введите новый пароль — он будет сохранён как единственный токен доступа.
